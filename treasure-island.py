...
if choice1 == "right" :
    ...
    if choice2 == "wait":
        ...
        if choice3 == "blue":
            ...
            choice4 = ('''You entered a labyrinth. As you go down you see underground temple. You can go "back" or "forward" ''').lower()
            if choice4 == "back":
                ...
                if choice5 == "wield":
                    choice6 = input(''''You see 3 routes to treasure room . \nWhich do you choose "1" with deadly smoke , "2" with venemous snakes or "3" with 1 year hungry lions ''')
                    if choice6 == "1":
